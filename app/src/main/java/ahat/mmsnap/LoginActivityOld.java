...
//            mAuthTask.execute( (Void) null );
            ...
            {
                e.printStackTrace();
                Log.e( "MMSNAP:", "Error during login: " + e.getMessage() );
            }
...
//                                                                              Toast.makeText( LoginActivity.this, message, Toast.LENGTH_SHORT ).show();
                                                                              ...
                                                                              getRemoteUserInfo( LoginActivityOld.this );
                                                                          }
                                                                          catch ( JSONException e )
                                                                          {
                                                                              e.printStackTrace();
...
//                // Simulate network access.
            ...
            // register the new account in loginSuccess.
            return true;
        }
...
//                finish();
    ...
    public static void getRemoteUserInfo( final Context context )
    {
            ...
            public void onResponse( JSONObject response )
            {
                if( null != response )
                {
                    try
                    {
                        ...
                        editor.putString( context.getString(R.string.key_email ), response.getString( "email" ) );
                        editor.commit();
